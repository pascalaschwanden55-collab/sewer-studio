...
- **Datum:** 2026-06-22
- **Fortschreibung 2026-06-24:** Die Spec bleibt massgeblich. Aktueller Stand: `DamageMarkerController`, `QuickScanController`, Schritt 3 `CodingOverlayRenderController`, `DetectionConfirmationBuffer`, der erste `LiveDetectionController`-Schnitt, `CodingOsdMeterController`, der erste `CodingAiController`-Schnitt und `CodingFrameReadinessController` sind umgesetzt; dazu kamen `CodingUiUpdateWorkflow`, `LiveDetectionRuntimeStartWorkflow` und mehrere UI-Adapter. Aktuelle Vermessung: `PlayerWindow*.cs` = 95 Dateien / 5020 Zeilen, `PlayerWindow.xaml` = 822 Zeilen, zusammen 5842 Zeilen. Die alte Angabe "33 Dateien / ~7.500 Zeilen" ist historisch.
