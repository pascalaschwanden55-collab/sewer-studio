...
| A1-08 | Mittel → **teilweise erledigt** | `UiArchitectureGuardTests` schützt die Composition-Root-Grenze; Player-Core- und Overlay-Host-Regeln wurden fachlich einsortiert, der Sammeltest sank auf 1.621 Zeilen | Weitere Regeln fachlich aufteilen und wichtige String-Token-Prüfungen schrittweise durch Typ-/Verhaltenstests ersetzen |
