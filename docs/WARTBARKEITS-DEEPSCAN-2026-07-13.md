...
| A1-08 | Mittel → **teilweise erledigt** | `ArchitectureFitnessTests.cs` bleibt groß; `UiArchitectureGuardTests` enthält jetzt die echte Composition-Root-Regel | Weitere allgemeine UI-Grenzen fachlich verschieben und alte Textsuchen schrittweise durch Verhaltens- oder Strukturtests ersetzen |
