...
- **Gesamtprüfung grün:** 8.831 Tests bestanden (2.526 Infrastruktur, 1.835 Pipeline, 4.408 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
| A8-07 | Niedrig → **erledigt** | `UserError`, `UserFacingException` und `UserErrorArchitectureTests`; KI-Sicherungsstatus nachgehärtet | Technische Ausnahmen werden zentral und verständlich abgebildet, vollständig protokolliert und nie mehr roh im UI-Dialog angezeigt; bewusst sichere Fachhinweise bleiben möglich |
