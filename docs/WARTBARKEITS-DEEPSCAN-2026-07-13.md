...
- **Gesamtprüfung grün:** 8.838 Tests bestanden (2.528 Infrastruktur, 1.835 Pipeline, 4.413 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
| A8-07 | Niedrig → **erledigt** | `UserError`, `UserFacingException` und `UserErrorArchitectureTests`; KI-Sicherungs- und ViewModel-Status nachgehärtet | Technische Ausnahmen werden zentral und verständlich abgebildet, vollständig protokolliert und weder im UI-Dialog noch in sichtbaren ViewModel-Statusfeldern roh angezeigt; bewusst sichere Fachhinweise bleiben möglich |
