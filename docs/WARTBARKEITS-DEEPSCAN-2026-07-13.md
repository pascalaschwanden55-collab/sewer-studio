...
- **Gesamtprüfung grün:** 8.825 Tests bestanden (2.525 Infrastruktur, 1.835 Pipeline, 4.403 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
| A1-10 | Niedrig → **teilweise erledigt** | `ProtocolRegenerationAdapter` besitzt jetzt den echten IO-Pfad; `ProtocolRegenerationService` ist nur noch Kompatibilitätsfassade | Weitere IO-/seiteneffektbehaftete statische Klassen einzeln auf Instanzdienste umstellen; reine Rechner statisch lassen |
