...
- **Gesamtprüfung grün:** 8.862 Tests bestanden (2.531 Infrastruktur, 1.835 Pipeline, 4.434 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
|---|---|---|---|
| A1-01 | Hoch → **teilweise erledigt** | `PlayerWindow` bleibt mit 97 partiellen Dateien und 5.072 aggregierten Zeilen groß; zahlreiche Coding-, LiveDetection- und Playback-Controller sowie Tastaturhilfe, Bedieneingaben, Positions-, Wiedergabe-, Codierungsnavigation, Erkennungsbestätigung, manuelles Training, dessen Aufbau und die Codierungs-Bestätigung sind bereits ausgelagert; der tote zweite Ladeablauf ist entfernt | Weiter in kleinen Verhaltenseinheiten extrahieren; die bisherigen Auslagerungen sind über neununddreißig Verhaltensfälle geschützt |
...
| A1-10 | Niedrig → **teilweise erledigt** | Protokoll-Neuerzeugung, Plan-PDF-Import, Haltungs-/Schachtumbenennung, Dropdown-Speicher, Import-Quelldateispeicher und Projekt-Rettungspunkte besitzen injizierbare Instanzdienste; ihre bisherigen statischen Klassen sind nur noch Kompatibilitätsfassaden | Weitere IO-/seiteneffektbehaftete statische Klassen einzeln auf Instanzdienste umstellen; reine Rechner statisch lassen |
