...
- **Gesamtprüfung grün:** 8.786 Tests bestanden (2.518 Infrastruktur, 1.819 Pipeline, 4.387 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 95 GPU-freie Sidecar-Tests grün.
...
| A6-06 | Mittel → **teilweise erledigt** | PDF: leer/abgeschnitten; XTF: abgeschnittene Datei vor gültiger Folgedatei | PDF und XTF sind als Einzelfehler statt Gesamt-Absturz geschützt; WinCan und FDB bleiben offen |
