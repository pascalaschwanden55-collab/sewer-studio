...
- **Gesamtprüfung grün:** 8.829 Tests bestanden (2.526 Infrastruktur, 1.835 Pipeline, 4.406 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
|---|---|---|---|
| A1-01 | Hoch → **teilweise erledigt** | `PlayerWindow` bleibt mit 97 partiellen Dateien und 5.423 aggregierten Zeilen groß; zahlreiche Coding-, LiveDetection- und Playback-Controller sind bereits ausgelagert | Weiter in kleinen Verhaltenseinheiten extrahieren; neu ausgelagerte Bedieneinstellungen sind über `IPlayerControlSettingsStore` und acht Tests geschützt |
