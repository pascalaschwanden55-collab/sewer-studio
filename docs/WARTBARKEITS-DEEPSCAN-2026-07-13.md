...
- **Gesamtprüfung grün:** 8.840 Tests bestanden (2.528 Infrastruktur, 1.835 Pipeline, 4.415 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
|---|---|---|---|
| A1-01 | Hoch → **teilweise erledigt** | `PlayerWindow` bleibt mit 97 partiellen Dateien und 5.335 aggregierten Zeilen groß; zahlreiche Coding-, LiveDetection- und Playback-Controller sowie Tastaturhilfe und Bedieneingaben sind bereits ausgelagert | Weiter in kleinen Verhaltenseinheiten extrahieren; Bedieneinstellungen, Anzeige, Eingabesteuerung und Tastaturhilfe sind über kleine Klassen und einundzwanzig Verhaltensfälle geschützt |
