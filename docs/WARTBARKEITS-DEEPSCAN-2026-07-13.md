...
- **Gesamtprüfung grün:** 8.834 Tests bestanden (2.528 Infrastruktur, 1.835 Pipeline, 4.409 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
...
| A1-08 | Mittel → **teilweise erledigt** | `UiArchitectureGuardTests` schützt die Composition-Root-Grenze; Player-Core-, Overlay-Host- und Dispatcher-Regeln wurden fachlich einsortiert, der Sammeltest sank auf 1.592 Zeilen | Weitere Regeln fachlich aufteilen und wichtige String-Token-Prüfungen schrittweise durch Typ-/Verhaltenstests ersetzen |
