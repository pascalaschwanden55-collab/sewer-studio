...
- **Gesamtprüfung grün:** 8.826 Tests bestanden (2.526 Infrastruktur, 1.835 Pipeline, 4.403 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der vollständige Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 97 GPU-freie Sidecar-Tests grün.
