...
- **Gesamtprüfung grün:** 8.743 Tests bestanden (2.513 Infrastruktur, 1.813 Pipeline, 4.355 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der Release-Build endet mit 0 Fehlern und 0 Warnungen.
...
| ID | Schweregrad | Fundstelle | Empfehlung |
|---|---|---|---|
| A6-01 | Hoch → **teilweise erledigt** | Die Bestandsaufnahme zeigt 133 STA-Testdateien und weiterhin viele Quelltext-Guards; zwei einfache Fenster besitzen inzwischen einen echten Öffnen-/Schließen-Smoke | Zwei weitere ViewModels werden mit sechs Verhaltenstests direkt ausgeführt; weitere ViewModels sowie Smokes der Haupt- und Fachfenster bleiben offen |
