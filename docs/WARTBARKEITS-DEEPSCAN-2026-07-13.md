...
- **Gesamtprüfung grün:** 8.785 Tests bestanden (2.517 Infrastruktur, 1.819 Pipeline, 4.387 UI und 62 ProjectModernizer). Zwei maschinengebundene Tests wurden planmäßig übersprungen. Der Release-Build endet mit 0 Fehlern und 0 Warnungen. Zusätzlich sind 5 QGIS-Python-Smokes und 95 GPU-freie Sidecar-Tests grün.
...
| A6-06 | Mittel → **teilweise erledigt** | PDF: `PdfImportNegativeTests` prüft leere und abgeschnittene Dateien über den öffentlichen Adapter | PDF ist als Einzelfehler statt Absturz geschützt; XTF, WinCan und FDB bleiben offen |
