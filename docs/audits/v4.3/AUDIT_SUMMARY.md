...
| 5.2 | ~~ServiceProvider.cs (657 Zeilen) zerlegen~~ — 6 Module extrahiert (5.2.A-F): ImportExport, ProtocolReports, DevisSanierung, VsaCatalogResolver, AiPipeline, KnowledgeBase. ServiceProvider.cs 678 → 255 Zeilen (-62 %). 645 Tests gruen. ✅ 2026-05-04 | B2 (2/3) | 1 Woche (geplant) / ~3-4 h (effektiv) |
