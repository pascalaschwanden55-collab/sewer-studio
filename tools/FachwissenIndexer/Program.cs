...
public static class RuleExtractor
{
    ...
    [
        ...
        new("kanaltv_wincan_normalviewer", "Datenabgabe", "WinCan Normal-Viewer",
            "Bei WinCan-Abgaben soll der Normal-Viewer mitgeliefert werden, nicht nur der Light-Viewer.",
            ["wincan", "normal-viewer"]),
