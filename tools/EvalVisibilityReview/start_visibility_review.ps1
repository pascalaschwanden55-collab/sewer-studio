param(
    ...
    [int]$Port = 8771,
    [string]$Title = "SewerStudio Sichtbarkeits-Review",
    [string]$Question = "Ist der Schaden im Einzelbild wirklich sichtbar?",
    [string]$YesText = "1 Ja sichtbar",
    [string]$NoText = "2 Nein",
    [string]$MaybeText = "3 Unsicher",
    [switch]$NoBrowser
)
