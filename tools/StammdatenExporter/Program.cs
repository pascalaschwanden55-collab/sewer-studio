...
//
// Ruft den bestehenden StammdatenAggregator (XTF + PDF + FDB) pro IBAK/KIAS-
...
for (var i = 0; i < args.Length; i++)
{
    ...
    switch (a)
    {
        ...
        case "--haltungs-folders":
            ...
            // separat vom KIAS-Aggregator behandelt.
            if (i + 1 >= args.Length) { PrintUsageAndExit(2); return; }
...
// wo PDFs nicht der KIAS-Konvention 'H_*.pdf' folgen.
...
static void PrintUsageAndExit(int code)
{
    Console.Error.WriteLine("""
        ...
        Modi:
          --root <Pfad>             KIAS/IBAK-Export-Root (XTF + PDF + FDB).
