        ...
        PlayerWindowControllerSetDependencies dependencies)
    {
        ...
        return PlayerWindowControllerSetFactory.Create(
            new PlayerWindowControllerSetControls(
                ...
                VolumeSlider: window.VolumeSlider,
                VolumeText: window.VolumeText,
                MuteButton: window.MuteButton,
                MuteIcon: window.MuteIconText,
                OverlayOpacitySlider: window.OverlayOpacitySlider,
                OverlayOpacityText: window.OverlayOpacityText,
