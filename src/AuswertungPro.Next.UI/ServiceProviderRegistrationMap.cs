...
internal static class ServiceProviderRegistrationMap
{
    public static IReadOnlyDictionary<Type, object> Create(ServiceProvider services)
    {
        ...
        return new Dictionary<Type, object>
        {
            ...
            [typeof(IShaftDistributionService)] = services.ShaftDistribution,
            ...
            [typeof(ISchachtProtocolFileLocator)] = services.SchachtProtocolFiles,
            ...
            [typeof(AuswertungPro.Next.Application.Dossiers.IDossierComponentListExportService)] = services.DossierComponentLists,
            ...
            [typeof(AuswertungPro.Next.Application.Dossiers.IDossierPdfAssemblyService)] = services.DossierPdfAssembly,
