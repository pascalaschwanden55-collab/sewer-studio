...
/// <summary>Liest Werte interaktiver PDF-Formulare mit PdfPig.</summary>
public sealed class PdfFormFieldReaderService : IPdfFormFieldReader
{
    public IReadOnlyList<PdfFormFieldEntry> GetPageFieldEntries(string pdfPath, int pageNumber)
    {
