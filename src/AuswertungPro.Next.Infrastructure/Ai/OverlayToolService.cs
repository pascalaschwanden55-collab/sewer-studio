...
public sealed class OverlayToolService : IOverlayToolService
{
    ...
    public static double InverseCircleSegmentPercent(double targetPercent)
        => PipeGeometryMath.InverseCircleSegmentPercent(targetPercent);
