...
/// - /api/generate fuer Legacy Text/Vision
/// - /api/chat fuer strukturierte Ausgabe mit JSON-Schema und Bildern
/// </summary>
public sealed class OllamaClient : IDisposable
{
    ...
    private static List<Dictionary<string, object?>> BuildMessageList(IReadOnlyList<ChatMessage> messages)
    {
