...
| Architektur | B+ | A− | Schichten einbahnig, Fitness-Tests, Composition Root schlank; Sidecar-Version im Hauptpfad geprüft | 6 Großdateien und doppelt gepflegter C#/Python-Vertrag | AP-34 |
| Codequalität | B | B+ | Neue Großdateien werden verhindert; vierzehn frühere Großdateien sind inzwischen unter 1.000 Zeilen | Noch 6 Produktionsdateien >1.000 Zeilen | AP-34 |
...
| P2-18 🔄 | God-Klassen werden schrittweise zerlegt; zusätzlich sind PDF-Verteilung, Systemmonitor, Kostenrechner und Schachtseite unter 1.000 Zeilen. Die ausgelagerten Aufgaben sind getrennt testbar. | AP-34, Commit `6c656ef6` plus aktuelle Pakete |
...
| AP-34 🔄 | Großklassen schrittweise nach Verantwortung zerlegen; Altliste im Fitness-Test verkleinern | P2 | fortlaufend; Altliste von 20 auf 6 Dateien gesenkt. Zuletzt wurden PDF-Verteilung, Systemmonitor, Kostenrechner und Schachtseite getrennt. |
