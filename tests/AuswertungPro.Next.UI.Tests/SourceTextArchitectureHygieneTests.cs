...
public sealed class SourceTextArchitectureHygieneTests
{
    ...
    public void Player_window_coding_tool_selection_guard_lives_in_focused_suite()
    {
        ...
        Assert.True(File.Exists(focusedPath), "Coding-ToolSelection-Architekturguard soll in einer eigenen fokussierten Testdatei liegen.");

        var focused = File.ReadAllText(focusedPath);
        const string methodName = "PlayerWindow_coding_tool_selection_lives_in_policy";
    ...
    public void Player_window_coding_calibration_guards_live_in_focused_suite()
    {
        ...
        Assert.True(File.Exists(focusedPath), "Coding-Calibration-Architekturguards sollen in einer eigenen fokussierten Testdatei liegen.");
    ...
    public void Player_window_overlay_rendering_guards_live_in_focused_suite()
    {
        ...
        var methodNames = new[]
        {
            ...
            "PlayerWindow_ai_overlay_shape_rendering_lives_in_player_renderers"
        };
    ...
    public void Player_window_visual_infrastructure_guards_live_in_focused_suite()
    {
        ...
        var methodNames = new[]
        {
            ...
            "PlayerWindow_tool_badge_rendering_lives_in_renderer",
    ...
    [InlineData("PlayerWindowCodingToolSelectionArchitectureTests.cs")]
    ...
    [InlineData("PlayerWindowCodingTimelineArchitectureTests.cs")]
