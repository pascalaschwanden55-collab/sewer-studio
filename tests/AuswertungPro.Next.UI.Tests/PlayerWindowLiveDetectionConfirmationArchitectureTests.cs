...
public sealed class PlayerWindowLiveDetectionConfirmationArchitectureTests
{
    ...
    public void PlayerWindow_live_detection_confirmation_actions_live_in_actions_partial()
    {
        ...
        var correctionSelectionPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionCorrectionCodeSelectionService.cs");
        var correctionSelectionFactoryPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionCorrectionCodeSelectionServiceFactory.cs");
        var correctionSelectionWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionCorrectionCodeSelectionWorkflow.cs");
        var displayWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionConfirmationDisplayWorkflow.cs");
        var frameExporterPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionTrainingFrameExporter.cs");
        var exportPlannerPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionTrainingExportPlanner.cs");
        var annotationWriterPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionTrainingAnnotationWriter.cs");
        var trainingWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionConfirmationTrainingWorkflow.cs");
        var trainingResultWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionConfirmationTrainingResultWorkflow.cs");
        var acceptCommandWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionConfirmationAcceptCommandWorkflow.cs");
        var correctCommandWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionConfirmationCorrectCommandWorkflow.cs");
        var skipCommandWorkflowPath = Path.Combine(uiRoot, "Ai", "Live", "LiveDetectionConfirmationSkipCommandWorkflow.cs");
        ...
        Assert.Contains("dependencies.TeacherAnnotations", trainingControllerSetFactory);
        ...
        Assert.Contains("_exportPlanner.PlanAccepted", annotationWriter);
        Assert.Contains("_exportPlanner.PlanCorrected", annotationWriter);
        Assert.Contains("annotations.AppendAsync", annotationWriter);
