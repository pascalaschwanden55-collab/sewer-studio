...
public sealed class SchaechtePageCommandArchitectureTests
{
    [Fact]
    public void SchaechtePageViewModel_delegiert_dropdown_command_erzeugung_an_factory()
    {
        ...
        Assert.Contains("DropdownCommandFactory.Create(", constructorBody, StringComparison.Ordinal);
